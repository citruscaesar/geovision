...
if __name__ == "__main__":
    ...
    if args.test_dataloader:
        ...
        memory_profile = memory_usage((test_dataloader, (dataset, config.get_dataloader_params(), int(args.limit), args.save_plots)))
    else:
        print("testing dataset")
        memory_profile = memory_usage((test_dataset, (dataset, config.get_dataloader_params()["batch_size"], int(args.limit), args.save_plots)))
